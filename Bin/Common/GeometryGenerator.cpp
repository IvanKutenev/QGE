...
void GeometryGenerator::CreateCylinder(float bottomRadius, float topRadius, float height, UINT sliceCount, UINT stackCount, MeshData& meshData, bool BuildCaps)
{
	meshData.Vertices.clear();
	meshData.Indices.clear();
